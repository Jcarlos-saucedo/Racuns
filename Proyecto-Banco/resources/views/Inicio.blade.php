  ...
  <section>
    <div class="navbar is-fixed-top navbar-end" style="background-color: #0000009c;">
      ...
      <div class="navbar-end ">
        ...
        @auth
          <div class="navbar-item" >
            <div class="has-text-weight-bold has-text-centered" style="background-color:#E3B53B; width:90px; height: 30px; border-color:#E3B53B; color:black">
        ...
        @endauth
        @guest
          <div class="navbar-item" style="margin-right: 120px;" >
            <div class="button has-text-weight-bold" style="background-color:#E3B53B; border-color:#E3B53B; color:white;"><a style="color:white;" href="/loguear">Acceso</a></div>
          </div>
        @else
          <div class="navbar-item" >
            <div class="button has-text-weight-bold" style="background-color:#E3B53B; border-color:#E3B53B; color:white;"><a style="color:white;" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Cerrar Sesion</a></div>
          </div>
